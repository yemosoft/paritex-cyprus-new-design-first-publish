...
onUnmounted(  () => {
     ...
     /* @ts-ignore */
    //document.querySelector('html').classList.remove('h-screen')
    /* @ts-ignore */
...
<template>
    <header class="absolute top-0 flex flex-wrap sm:justify-start sm:flex-nowrap w-full text-sm px-3 py-3 dark:bg-slate-950 ">
      <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
        <div class="flex items-center justify-between">
         <RouterLink to="/page/home" class="flex-none text-xl font-semibold dark:text-white" href="#!" aria-label="Brand">
                        <SiteLogo></SiteLogo>
                    </RouterLink>
          <div class="sm:hidden">
