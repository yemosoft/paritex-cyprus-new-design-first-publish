...
import { useGlobalPageSession } from '../../../stores/GlobalPageSession';
import { computed, ref } from 'vue';

const globals = useGlobalPageSession()
const cookieAccepted = ref(globals.cookieAccepted)
const show = ref('waiting')
setTimeout(() => {
    show.value = (!cookieAccepted.value) ? 'true' : 'false'
}, 5000)

const allow = () => {
    globals.acceptCookie()
    show.value = 'false'
}
...
<template>
    <div v-if="show == 'true'" class="fixed bottom-0 right-0 z-[60] sm:max-w-xl w-full mx-auto p-6">
        <!-- Card -->
        <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800/80 dark:border-gray-700">
            <div class="flex gap-x-5">
                <svg class="hidden sm:block flex-shrink-0 w-20" width="72" height="63" viewBox="0 0 72 63" fill="none"
                    ...
                    <path
                        ...
                        stroke="currentColor" class="dark:stroke-gray-200" stroke-width="2" stroke-linecap="round" />
                    <path
                    ...
                    <path
                        ...
                        fill="currentColor" class="text-gray-800 dark:fill-gray-200" />
                    <path
                ...
                <div class="grow">
                    ...
                    <div class="mt-5 inline-flex gap-x-2">
                        <button @click="allow()" type="button"
