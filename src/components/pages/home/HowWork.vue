...
<template>
    <!-- Icon Blocks -->
    <div class="mt-24 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="">
            <div class="grid  sm:grid-cols-2 lg:grid-cols-4 items-center justify-center gap-12">
                <!-- Icon Block -->
                <div class="justify-center">
                    <div
                        ...
                        <svg class="w-7 h-7 text-blue-600 dark:text-blue-500" xmlns="http://www.w3.org/2000/svg" width="16"
